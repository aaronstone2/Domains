# `firecracker/security` — PROGRESS log
...
For interview-day relevance, this leaf is queryable through the harness — try `pnpm harness ask "<your-security-related-symptom>"` to see what's available.
