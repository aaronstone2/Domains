# Plan — `market/theory-user-agency-control`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `standard`; overridden to exhaustive per directive)
- **Scope:** Locus of control, sense of agency, user-control vs autonomy preferences/personalization in autonomous systems.
- **Primary tables:** `theory_concepts`, `claims`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `theory:thy.user-agency.*`
- **Row estimate:** ~4 theory_concepts, ~8 claims
- **Why this is its own leaf:** Merges locus-of-control + user-control-autonomy (same agency-psychology authority) into one leaf.
