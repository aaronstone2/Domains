# Plan — `market/theory-perception-gestalt`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `standard`; overridden to exhaustive per directive)
- **Scope:** Visual perception: Gestalt grouping, preattentive processing (Treisman), graphical-perception effectiveness (Cleveland & McGill).
- **Primary tables:** `theory_concepts`, `claims`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `theory:thy.perception.*`
- **Row estimate:** ~6 theory_concepts, ~8 claims
- **Why this is its own leaf:** Distinct perceptual-psychology authority; grounds encoding/grouping choices for graph layouts.
