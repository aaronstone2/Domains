# Plan — `market/theory-direct-manipulation`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `exhaustive`; overridden to exhaustive per directive)
- **Scope:** Direct-manipulation foundations (Shneiderman 1983): continuous representation, physical reversible actions, immediate feedback; absorbs reversibility/undo.
- **Primary tables:** `theory_concepts`, `claims`, `relationships`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `theory:thy.direct-manip.*`
- **Row estimate:** ~6 theory_concepts, ~10 claims
- **Why this is its own leaf:** Foundational Shneiderman corpus; MetroGraph's core strength → exhaustive. Absorbs the non-leaf reversibility pattern.
