# Plan — `market/theory-tangible-embodied`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `standard`; overridden to exhaustive per directive)
- **Scope:** Tangible & embodied interaction (Ishii/Ullmer): spatial metaphor, physicality — grounds metro-map 'substance' of nodes.
- **Primary tables:** `theory_concepts`, `claims`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `theory:thy.tangible.*`
- **Row estimate:** ~4 theory_concepts, ~6 claims
- **Why this is its own leaf:** Distinct MIT Media Lab/TEI authority; spatial-embodiment grounding for the metro metaphor.
