# Plan — `market/theory-agentic-ux-patterns`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `standard`; overridden to exhaustive per directive)
- **Scope:** Agentic UX patterns: interruptibility, step-by-step logs, approve/veto, control handoff for autonomous agents.
- **Primary tables:** `theory_concepts`, `claims`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `theory:thy.agentic-ux.*`
- **Row estimate:** ~4 theory_concepts, ~8 claims
- **Why this is its own leaf:** Distinct emerging agentic-UX practitioner corpus; absorbs generative-AI design principles (non-leaf).
