# Plan — `market/competitors-workflow-automation-oss`

## Leaf spec (Session 0)

- **Cluster:** competitive
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `standard`; overridden to exhaustive per directive)
- **Scope:** OSS / Microsoft / embedded / flow-based automation: Activepieces, Power Automate, Node-RED, Prismatic, Windmill, Latenode.
- **Primary tables:** `products`, `product_features`, `competitors`
- **Depends on:** `companies`, `market-landscape`
- **Claim categories (owned):** `competition:comp.wfa-oss.*`, `feature:comp.wfa-oss.feat.*`
- **Row estimate:** 6 products, ~50 product_features
- **Why this is its own leaf:** Second half of workflow-automation under cap; OSS/embedded authority distinct from commercial iPaaS.
