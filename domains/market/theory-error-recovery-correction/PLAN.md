# Plan — `market/theory-error-recovery-correction`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `standard`; overridden to exhaustive per directive)
- **Scope:** Error detection/recovery & correction loops: over-reliance vs over-intervention, before/after visibility, persuasion paradox.
- **Primary tables:** `theory_concepts`, `claims`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `theory:thy.error-recovery.*`
- **Row estimate:** ~4 theory_concepts, ~6 claims
- **Why this is its own leaf:** Distinct error-recovery/calibrated-intervention authority; load-bearing for undo + before/after graph edits.
