# Plan — `market/theory-human-ai-interaction-design`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `exhaustive`; overridden to exhaustive per directive)
- **Scope:** Guidelines for Human-AI Interaction (Amershi et al. CHI 2019, 18 principles) + design-pattern catalogs.
- **Primary tables:** `theory_concepts`, `claims`, `relationships`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `hci:thy.human-ai.*`, `theory:thy.human-ai.*`
- **Row estimate:** ~5 theory_concepts, ~10 claims
- **Why this is its own leaf:** Foundational Amershi authority for AI-UI design → exhaustive; anchors the agentic-UX subcluster.
