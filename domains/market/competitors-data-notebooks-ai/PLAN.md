# Plan — `market/competitors-data-notebooks-ai`

## Leaf spec (Session 0)

- **Cluster:** competitive
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `standard`; overridden to exhaustive per directive)
- **Scope:** Notebooks + AI-native + lightweight data studios (AI+UI convergence signal): Hex, Observable, Google Sheets, Databox, Knowi, Basedash, Tictable, Index, Jupyter.
- **Primary tables:** `products`, `product_features`, `competitors`
- **Depends on:** `companies`, `market-landscape`
- **Claim categories (owned):** `competition:comp.bi-notebook.*`, `feature:comp.bi-notebook.feat.*`
- **Row estimate:** 9 products, ~60 product_features
- **Why this is its own leaf:** Second half of data-bi-notebook under cap; AI-native notebook authority distinct from BI dashboards.
