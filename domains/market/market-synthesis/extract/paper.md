...
Expected gross margins: **65–75% at scale** [BMC:cost-structure]

**Series A Target** ($2–5M ARR): 30% gross margin  
**Series B Target** ($10M+ ARR): 70% gross margin

**Unit Economics**
- CAC (enterprise): $2K–5K per customer, 12–18 month payback [BMC:cost-structure]
- LTV:CAC ratio targets: 3:1 (enterprise), 5:1 (SMB freemium) [BMC:cost-structure]
...
Each claim carries a verdict and an agreement score (fraction of skeptics that did not refute it). Claims cited in the body as  resolve here.
