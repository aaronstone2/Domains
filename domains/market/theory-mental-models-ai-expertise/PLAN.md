# Plan — `market/theory-mental-models-ai-expertise`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `standard`; overridden to exhaustive per directive)
- **Scope:** User mental models of AI; expert/novice gap; when LLM assistants fail and who blames the UI.
- **Primary tables:** `theory_concepts`, `claims`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `theory:thy.mental-models.*`
- **Row estimate:** ~4 theory_concepts, ~8 claims
- **Why this is its own leaf:** Distinct mental-models authority; scaffolds the expert-vs-novice ICP trust split.
