# Plan — `market/theory-information-foraging`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `exhaustive`; overridden to exhaustive per directive)
- **Scope:** Information Foraging Theory (Pirolli & Card): information scent, patch/diet models — why poor cues drive flight to chat.
- **Primary tables:** `theory_concepts`, `claims`, `relationships`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `theory:thy.info-forage.*`
- **Row estimate:** ~5 theory_concepts, ~10 claims
- **Why this is its own leaf:** Distinct PARC authority; directly explains the flee-to-AI-chat thesis → exhaustive.
