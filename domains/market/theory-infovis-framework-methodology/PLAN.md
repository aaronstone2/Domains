# Plan — `market/theory-infovis-framework-methodology`

## Leaf spec (Session 0)

- **Cluster:** theory
- **Depth:** exhaustive (Session-0 risk-weighted suggestion was `standard`; overridden to exhaustive per directive)
- **Scope:** InfoVis design methodology: Munzner nested model, Shneiderman mantra, Cleveland-McGill encoding hierarchy.
- **Primary tables:** `theory_concepts`, `claims`
- **Depends on:** _(none — wave 1)_
- **Claim categories (owned):** `theory:thy.infovis-method.*`
- **Row estimate:** ~5 theory_concepts, ~8 claims
- **Why this is its own leaf:** Munzner/Shneiderman methodological authority; the design-process backbone for the whole viz cluster.
